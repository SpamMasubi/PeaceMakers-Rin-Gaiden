...
public class Tsukimi : MonoBehaviour
{
    ...
    public static bool startTsukimiBoss = false;

    Vector3 lastTargetPosition;

    void Awake()
    {
        startTsukimiBoss = true;
    }
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (_player != null && !TsukimiHealth.isBossDead)
        {
