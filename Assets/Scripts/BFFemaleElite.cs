...
public class BFFemaleElite : MonoBehaviour
{
    [SerializeField]
    Transform player;
    ...
    void StopAttackingPlayer()
    {
        ...
        isAttacking = false;
        canMove = true;
        anim.Play("BF Female Fighter Elite walking");
    }
    ...
    void ChasePlayer()
    {
        ...
        anim.Play("BF Female Fighter Elite Running");
    }
    ...
    void shootPlayer()
    {
        ...
        if (distToPlayer <= 5 && attackCounter < 0)
        {
            rb2d.velocity = Vector3.zero;
            anim.Play("BF Female Fighter Elite Attack");
            sfxMan.FemaleEliteAttack.Play();
